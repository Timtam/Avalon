...
Des Weiteren besitzt das Kommando pos die folgenden Erweiterungen:

- poss: Aktuelle Position speichern (nur bis zum Neustart von MUSHclient)
- posg: Gespeicherte Position abfragen
- posw: Benötigte Bewegungen von der aktuellen zur gespeicherten Position ansagen
  z.B. 4 mal Westen, 3 mal Norden
- posn: Benötigte Bewegungen von der aktuellen zur gespeicherten Position beim Laufen automatisch ansagen / umschalten

Obige Erweiterungen funktionieren nur auf Karten, auf denen Koordinaten bekannt sind (z.B. außerhalb von Städten auf Nereid, den Inseln von Elandor oder der Unterwelt). Die angegebenen Bewegungen sind "Luftlinie". Hindernisse wie Felswände oder der Lavafluss werden nicht berücksichtigt.
