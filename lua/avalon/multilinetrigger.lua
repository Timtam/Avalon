...
trigger=MultilineTrigger('Rune/Harden.ogg','Runenschmiede')
...
trigger=MultilineTrigger('Rune/Hammer1.ogg','Runenschmiede')
...
trigger=MultilineTrigger('Smith/hammer1.ogg')
trigger:Line("Mit einem lauten Knall laesst .* Schmiedehammer .*",true,true)
trigger:Line("niedersausen.",false,true)
trigger:Inject()

trigger=MultilineTrigger('Rune/EngraveCorrect.ogg','Runenschmiede')
...
trigger=MultilineTrigger('Rune/Hammer2.ogg','Runenschmiede')
...
trigger=MultilineTrigger('Mining/MeltBegin.ogg')
trigger:Line("Fast sofort flackert im Ofen ein heisses")
trigger:Line("Feuerchen auf.")
trigger:Inject()

trigger=MultilineTrigger('Mining/MeltClick.ogg')
...
trigger=MultilineTrigger('Mining/PressContinue.ogg')
...
trigger=MultilineTrigger('Mining/DigCaveInDistant.ogg')
...
trigger=MultilineTrigger('Mining/PressBegin.ogg')
...
trigger=MultilineTrigger('Player/Voodoo.ogg')
...
trigger=MultilineTrigger('WarEchoes/Finish.ogg')
...
trigger=MultilineTrigger('Spells/Blink.ogg')
