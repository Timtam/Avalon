...
trigger=MultilineTrigger('psnd("WarEchoes/Finish.ogg")')
...
trigger=MultilineTrigger('psnd("Spells/Blink.ogg")')
...
trigger=MultilineTrigger('psnd("Misc/NPCTask.ogg")')
trigger:Line("Aufgabe geloest!",false,false)
trigger:Line("Gratuliere, Du hast die Aufgabe geloest!",false,false)
trigger:Inject()

trigger=MultilineTrigger('psnd("Clerics/CurePoison2.ogg")','Kleriker')
