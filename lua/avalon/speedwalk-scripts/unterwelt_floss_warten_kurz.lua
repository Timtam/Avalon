...
Class.Avalon_Unterwelt_Floss_Warten_Kurz(Script)

function Avalon_Unterwelt_Floss_Warten_Kurz:setup()
...
function Avalon_Unterwelt_Floss_Warten_Kurz:teardown()
...
function Avalon_Unterwelt_Floss_Warten_Kurz:get_duration()
  return 75.0
end

function Avalon_Unterwelt_Floss_Warten_Kurz:inverts(s)
  return Types.type(s) == 'Avalon_Unterwelt_Floss_Aussteigen'
end

return Avalon_Unterwelt_Floss_Warten_Kurz